...
const CriarTarefa = ({handleClose, tarefas, setTarefas}) =>{
  ...
  const handleSalvar = () => {
    if (inicioTarefa > fimTarefa) {
      setErroData('A data de início não pode ser posterior à data de término.');
      return;
    }
    setErroData('');
        ...
        <CardContent sx={{
          ...
          <Grid item xs={12}>
            <FormControl fullWidth>
              ...
              <FormHelperText id="tarefa_titulo_helper_text">Lembrete.</FormHelperText>
            </FormControl>
          </Grid>
          <Grid item xs={12}>  
            <FormControl fullWidth>
